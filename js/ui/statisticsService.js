...
class StatisticsService {
    ...
    getTypeIcon(type) {
        const iconMap = {
            ...
            'Snow Squall': '<i class="fas fa-snowflake" style="color: #93c5fd;"></i>',
            'Sleet': '<i class="fas fa-circle" style="color: #38bdf8;"></i>',
            ...
            'Wildfire': '<i class="fas fa-fire" style="color: #ea580c;"></i>',
